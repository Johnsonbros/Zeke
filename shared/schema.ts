...
// Evidence - provenance tracking for knowledge graph claims
export const kgEvidence = pgTable("kg_evidence", {
  id: text("id").primaryKey(),
  sourceType: text("source_type").notNull(),  // e.g., "conversation", "document", "user_input"
  sourceId: text("source_id").notNull(),       // ID of the source (conversation ID, document ID, etc.)
...
// Relationship status types for conflict handling
