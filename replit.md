...
- **Input/Output**: SMS/MMS integration with GPT-4o Vision for image processing (enhanced OCR with contact info extraction for phone numbers, emails, addresses), voice pipeline for Omi Pendant lifelogs, and Smart Notification Batching.
