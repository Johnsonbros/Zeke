...
- [Other APIs](https://docs.omi.me/doc/developer/api#other-apis)
- [Related Documentation](https://docs.omi.me/doc/developer/api#related-documentation)
...
3. Under “Developer API Keys”, click **Create Key**
...
Learn more about the Model Context Protocol in the [MCP documentation](https://docs.omi.me/doc/developer/MCP).

* * *

## [​](https://docs.omi.me/doc/developer/api\#other-apis)  Other APIs

Looking for different API capabilities? Omi offers several APIs for different use cases:

[**Integration Import APIs** \\
\\
**For App Developers** \- Create conversations and memories on behalf of users who have enabled your app](https://docs.omi.me/doc/developer/apps/Import) [**Webhook Triggers** \\
\\
**For App Developers** \- Receive real-time notifications when memories are created or transcripts are processed](https://docs.omi.me/doc/developer/apps/Integrations) [**Chat Tools** \\
\\
**For App Developers** \- Add custom tools that Omi’s AI can invoke during conversations](https://docs.omi.me/doc/developer/apps/ChatTools) [**Audio Streaming** \\
\\
**For App Developers** \- Process raw audio bytes in real-time via WebSocket](https://docs.omi.me/doc/developer/apps/AudioStreaming)
...
## [​](https://docs.omi.me/doc/developer/api\#related-documentation)  Related Documentation

[**MCP Integration** \\
\\
Connect AI assistants to your Omi data](https://docs.omi.me/doc/developer/MCP) [**Integration Apps** \\
\\
Build webhook-based apps for Omi](https://docs.omi.me/doc/developer/apps/Integrations) [**GitHub Issues** \\
\\
Report bugs or request features](https://github.com/BasedHardware/omi/issues) [**Discord Community** \\
\\
Get help from the community](http://discord.omi.me/)

[Contribution Guide](https://docs.omi.me/doc/developer/Contribution) [Model Context Protocol](https://docs.omi.me/doc/developer/MCP)
