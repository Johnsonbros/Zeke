...
|-------------|-------------|
| **Conversation Events** | `https://YOUR_REPLIT_URL/api/omi/memory-trigger` |
| **Real-time Transcript** | `https://YOUR_REPLIT_URL/api/omi/transcript` |
| **Day Summary** | `https://YOUR_REPLIT_URL/api/omi/day-summary` |
| **Chat Tools (Query)** | `https://YOUR_REPLIT_URL/api/omi/query` |
