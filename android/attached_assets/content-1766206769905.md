...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/eas/workflows/automating-eas-cli.mdx)
...
[Workflow examples\\
\\
Learn how to use workflows to create development builds, publish preview updates, and create production builds.](https://docs.expo.dev/eas/workflows/examples)
