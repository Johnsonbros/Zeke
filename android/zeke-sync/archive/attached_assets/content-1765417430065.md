...
[Coding agentfromGitHub Copilot](https://gh.io/coding-agent-docs) [Autopilot & Coded AgentsfromUiPath](https://uipath.github.io/uipath-python) [![Devin logo](https://agents.md/logos/devin-light.svg)![Devin logo](https://agents.md/logos/devin-dark.svg)\\
\\
DevinfromCognition](https://devin.ai/) [JulesfromGoogle](https://jules.google/) [![VS Code logo](https://agents.md/logos/vscode-light.svg)![VS Code logo](https://agents.md/logos/vscode-dark.svg)\\
\\
VS Code](https://code.visualstudio.com/docs/editor/artificial-intelligence) [![Ona logo](https://agents.md/logos/ona-light.svg)![Ona logo](https://agents.md/logos/ona-dark.svg)\\
\\
Ona](https://ona.com/) [Cursor](https://cursor.com/) [CodexfromOpenAI](https://openai.com/codex/) [Kilo Code](https://kilocode.ai/) [Aider](https://aider.chat/docs/usage/conventions.html#always-load-conventions) [![Windsurf logo](https://agents.md/logos/windsurf-light.svg)![Windsurf logo](https://agents.md/logos/windsurf-dark.svg)\\
\\
WindsurffromCognition](https://windsurf.com/) [Coding agentfromGitHub Copilot](https://gh.io/coding-agent-docs) [Autopilot & Coded AgentsfromUiPath](https://uipath.github.io/uipath-python) [![Devin logo](https://agents.md/logos/devin-light.svg)![Devin logo](https://agents.md/logos/devin-dark.svg)\\
\\
DevinfromCognition](https://devin.ai/) [JulesfromGoogle](https://jules.google/) [![VS Code logo](https://agents.md/logos/vscode-light.svg)![VS Code logo](https://agents.md/logos/vscode-dark.svg)\\
\\
VS Code](https://code.visualstudio.com/docs/editor/artificial-intelligence) [![Ona logo](https://agents.md/logos/ona-light.svg)![Ona logo](https://agents.md/logos/ona-dark.svg)\\
...
Ona](https://ona.com/) [Cursor](https://cursor.com/) [CodexfromOpenAI](https://openai.com/codex/) [Kilo Code](https://kilocode.ai/) [Aider](https://aider.chat/docs/usage/conventions.html#always-load-conventions) [![Windsurf logo](https://agents.md/logos/windsurf-light.svg)![Windsurf logo](https://agents.md/logos/windsurf-dark.svg)\\
\\
WindsurffromCognition](https://windsurf.com/)

[Factory](https://factory.ai/) [Gemini CLIfromGoogle](https://github.com/google-gemini/gemini-cli/blob/main/docs/get-started/configuration.md#available-settings-in-settingsjson) [goose](https://github.com/block/goose) [Semgrep](https://semgrep.dev/) [Amp](https://ampcode.com/) [Phoenix](https://phoenix.new/) [Warp](https://docs.warp.dev/knowledge-and-collaboration/rules#project-scoped-rules-1) [opencode](https://opencode.ai/docs/rules/) [Zed](https://zed.dev/docs/ai/rules) [RooCode](https://roocode.com/) [Factory](https://factory.ai/) [Gemini CLIfromGoogle](https://github.com/google-gemini/gemini-cli/blob/main/docs/get-started/configuration.md#available-settings-in-settingsjson) [goose](https://github.com/block/goose) [Semgrep](https://semgrep.dev/) [Amp](https://ampcode.com/) [Phoenix](https://phoenix.new/) [Warp](https://docs.warp.dev/knowledge-and-collaboration/rules#project-scoped-rules-1) [opencode](https://opencode.ai/docs/rules/) [Zed](https://zed.dev/docs/ai/rules) [RooCode](https://roocode.com/)
...
Rust\\
\\
![Contributor avatar](https://avatars.githubusercontent.com/u/204937752?v=4)![Contributor avatar](https://avatars.githubusercontent.com/u/219906144?v=4)![Contributor avatar](https://avatars.githubusercontent.com/u/655869?v=4)\\
\+ 268](https://github.com/openai/codex/blob/-/AGENTS.md) [**apache/airflow** \\
\\
...
\+ 4023](https://github.com/apache/airflow/blob/-/AGENTS.md) [**temporalio/sdk-java** \\
\\
